...
parser.add_argument('--result_path', type=str, default=f'runs/{datasets}_base/30/')
parser.add_argument('--gt_path', type=str, default=f'datasets/labels/{datasets}_label/')
